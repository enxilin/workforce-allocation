...
study_number=mdl.integer_var_matrix(employeelist,studylist)
number=mdl.binary_var_matrix(employeelist,studylist)
employee_study_varibility=mdl.integer_var_dict(employeelist)
for e in employeelist:
  for s in studylist:
