...
for e in employeelist:
  ...
  for s in studylist:
    print(s)
    print(study_number[e,s].solution_value)
    print(number[e,s].solution_value)
  print(employee_study_varibility[e].solution_value)
  print('.......')
print(total_study_varibility.solution_value)